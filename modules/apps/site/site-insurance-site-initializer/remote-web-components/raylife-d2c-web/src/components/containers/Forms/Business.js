...
import { validateOverallSales, validateOwnBrandLabel, validatePercentSales } from "../../../utils/businessFields";
  ...
  return (
    <div className="card">
      <div className="card-content">
        ...
        />
        {
          validatePercentSales(form?.basics?.properties?.businessClassCode) && <PercentageControlledInput
        ...
        {
          validateOwnBrandLabel(form?.basics?.properties?.businessClassCode) && <ControlledSwitch
        ...
        {
          validateOverallSales(form?.basics?.properties?.segment) && <PercentageControlledInput
