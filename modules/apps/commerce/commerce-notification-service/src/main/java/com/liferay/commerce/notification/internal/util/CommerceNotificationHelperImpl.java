...
public class CommerceNotificationHelperImpl
		...
		for (String toUserString : toUserStrings) {
			...
			if (toUser == null) {
				...
				_addNotificationQueueEntry(
					...
					fromName, toUserString, commerceNotificationTemplate.getTo(), subject, body, object);
	...
	private void _addNotificationQueueEntry(
			...
			CommerceNotificationTemplate commerceNotificationTemplate,
			String fromName, String toEmailAddress, String toFullName, String subject, String body,
			Object object)
		throws PortalException {

		User user = _userLocalService.getDefaultUser(CompanyThreadLocal.getCompanyId());
